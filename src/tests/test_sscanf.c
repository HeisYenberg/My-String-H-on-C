...
START_TEST(sscanf_spec_c_1) {
  ...
  int16_t res1 = my_sscanf(str, format, &c1);
...
START_TEST(sscanf_spec_c_3) {
  ...
  int16_t res1 = my_sscanf(str, format, &c11, &c12, &c13);
...
START_TEST(sscanf_spec_s_5) {
  ...
  int16_t res1 = my_sscanf(str, format, &c11, &c12);
...
START_TEST(sscanf_spec_n_5) {
  ...
  int16_t res1 = my_sscanf(str, format, &d1, &dd1, &f1, &ff1, &k1, &k1);
